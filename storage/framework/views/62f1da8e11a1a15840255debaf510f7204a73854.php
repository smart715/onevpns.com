                                    ...
                                    <div class="dt-module__list">
                                        ...
                                        <!-- Module Item -->
                                            <div class="dt-module__list-item">
                                                ...
                                                <!-- Module Content -->
                                                <a href="#" class="dt-module__list-item-content"> <?php echo e($log->process_descp); ?> </a>
                                                <!-- /module content -->

                                                <!-- Module Info -->
                                                <div class="dt-module__list-item-info">
                                                    <div class="badge-group">
                                                        <span class="badge bg-dark-blue text-white"><?php echo e($log->process_name); ?></span>
                                                        <span class="badge badge-danger"><?php echo e($log->ip); ?></span>
                                                    </div>
                                                    <?php $createdtime = strtotime($log->created_at)+3*60*60;  $newdate = date('d-m-y H:i', $createdtime);?>
                                                    <span><?php echo e($newdate); ?></span>
                                                </div>
                                                <!-- /module info -->
                                            </div>
                                            <!-- /module item -->
