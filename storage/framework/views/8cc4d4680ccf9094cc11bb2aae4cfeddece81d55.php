                            ...
                            <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-1 h1"><?php echo e($usercount); ?></p>
                        ...
                        <div class="dt-card">
                            ...
                            <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                ...
                                <div class="media">
                                    ...
                                    <!-- Media Body -->
                                    <div class="media-body">
                                        <p class="mb-1 h1"><?php echo e($multiuser); ?></p>
                                        <span class="d-block text-light-gray">All</span>
                                    </div>
                                    <!-- /media body -->
                                    ...
                                    <div class="media-body">
                                        <ul class="invoice-list">
                                            <li class="invoice-list__item">
                                                <span class="invoice-list__number"><?php echo e(count($servers)); ?></span> <span
                                                        class="invoice-list__label">All</span>
                                            </li>
                                            <li class="invoice-list__item">
                                                <span class="invoice-list__number"><?php echo e(count($servers->where('paid',1))); ?></span> <span
                                                        class="dot-shape bg-success"></span>
                                                <span class="invoice-list__label">Paid</span>
                                            </li>
                                            <li class="invoice-list__item">
                                                <span class="invoice-list__number"><?php echo e(count($servers->where('paid',0))); ?></span> <span
                                                        class="dot-shape bg-info"></span>
                                                <span class="invoice-list__label">Free</span>
                                            </li>
                                            <li class="invoice-list__item">
                                                <span class="invoice-list__number"><?php echo e(count($servers->where('ust_server_id', '!=' ,null))); ?></span> <span
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-12 col-sm-4">
                                        ...
                                        <canvas class="mx-auto mb-5 mb-sm-0 mb-md-5 mb-xl-0"
                                                id="estimation-doughnut1" data-fill="<?php echo e($freeCountry['sumUsers']); ?>"
                                    ...
                                    <div class="col-xl-8 col-md-12 col-sm-8">
                                        ...
                                        <ul class="dt-list dt-list-col-6">
                                            <?php if(isset($freeCountry['labels'])): ?>
                                                <?php $__currentLoopData = $freeCountry['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="dt-list__item">
                                                        <span class="dot-shape dot-shape-lg mr-2" style="background-color: <?php echo e($freeCountry['datasets'][0]['backgroundColor'][$k]); ?>"></span>
                                                        <span class="d-inline-block"><?php echo e($freeCountry['datasets'][0]['data'][$k]); ?> <?php echo e($v); ?></span>
                                                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-12 col-sm-4">
                                        ...
                                        <canvas class="mx-auto mb-5 mb-sm-0 mb-md-5 mb-xl-0" id="proposal-doughnut1"
                                                data-fill="<?php echo e($paidCountry['sumUsers']); ?>"
                                                height="110" width="110"></canvas>
                                        <!-- /chart -->
                                    ...
                                    <div class="col-xl-8 col-md-12 col-sm-8">
                                        ...
                                        <!-- List -->
                                        <ul class="dt-list dt-list-col-6">
                                            <?php if(isset($paidCountry['labels'])): ?>
                                            <?php $__currentLoopData = $paidCountry['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="dt-list__item">
                                                    <span class="dot-shape dot-shape-lg mr-2" style="background-color: <?php echo e($paidCountry['datasets'][0]['backgroundColor'][$k]); ?>"></span>
                                                    <span class="d-inline-block"><?php echo e($paidCountry['datasets'][0]['data'][$k]); ?> <?php echo e($v); ?></span>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                            <?php endif; ?>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-6 d-flex">
                                                <div class="d-flex flex-column justify-content-end align-items-end flex-fill">
                                                    ...
                                                    <div class="text-dark display-3 font-weight-500 mb-5"><span
                                                                id="lead-number1"><?php echo e($yearTotalFree); ?></span>
                                    ...
                                    <div class="col-xl-4 col-md-6 px-xl-10 pl-md-10 mb-8 mb-md-0">
                                        ...
                                        <ul class="dt-list flex-column">
                                            <?php $__currentLoopData = $capHighs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capHigh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="dt-list__item">
                                                <div class="d-flex align-items-center">
                                                    <span class="text-dark mr-1"><?php echo e($capHigh->country); ?>

                                                    <?php if($capHigh->type=='free'): ?>
                                                    ...
                                                    <span class="ml-auto"><?php echo e($capHigh->status_sum); ?></span>
                                                </div>
                                            </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
