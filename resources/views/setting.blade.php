                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="/vpn/admin/settings/post/cron" id="myForm" class="myForm">
                                            ...
                                            <div class="form-group">
                                                <label class="switch">
                                                    <input type="checkbox" id="switchCron" name="switchCron" @if($setting->cronjob == 1) checked @else @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="password-1" name="total" value="{{$setting->total}}">
                                            </div>
                                ...
                                <div id="subserver" class="tab-pane">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="/vpn/admin/settings/post/sub" id="myForm" class="myForm">
                                            ...
                                            <div class="form-group">
                                                <label class="switch">
                                                    <input type="checkbox" id="switchSub" name="switchSub" @if($setting->alternative_server == 1) checked @else @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label for="password-1">Cronjob Capacity</label>
                                                <input type="text" class="form-control" id="password-1" name="server_cap" value="{{$setting->server_cap}}">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="/vpn/admin/country/token" id="myForm" class="myForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="password-1" name="token_digital" value="{{$token->token}}">
                                            </div>
                                            <div class="form-group mb-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="/vpn/admin/settings/post/bundle" id="myForm" class="myForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="password-1" name="bundleid" value="{{$setting->bundleid}}">
                                            </div>
                                            <div class="form-group mb-0">
